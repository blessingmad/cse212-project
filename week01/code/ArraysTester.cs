public static class ArraysTester {
    ...
    private static double[] MultiplesOf(double number, int length)
    {
        ...
        // The variaable result will be used to store the output to be displayed at the console
        //the for loop loops the int i which is greater than 0 for a number of times represented by the parameter length.
        // i++ shows the increase of the number multiplied by.
